...
Scanmatcher::pose_t Scanmatcher::calcTransformation(pose_t & first_pose, pose_t & second_pose){
  pose_t transform;
...
Scanmatcher::pose_t Scanmatcher::calculate(pose_t & prev_pose,points2_t & first_scan,
                                            pose_t & curr_pose,points2_t & second_scan){
