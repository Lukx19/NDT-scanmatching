...
class Scanmatcher{
  public:
    ...
    Scanmatcher(size_t max_range,size_t resolution, size_t layers,scan_type scan):
      pose_(pose_t::Zero()),
      transform_(pose_t::Zero()),
    ...
    pose_t calculate(pose_t & prev_pose,points2_t & first_scan,
